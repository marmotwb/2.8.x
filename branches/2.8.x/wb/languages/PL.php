...
$TEXT['ALLOW_MULTIPLE_SELECTIONS'] = 'PozwÃÂ³l na wielokrotne wybory';
$TEXT['ALL_WORDS'] = 'Wszystkie slowa';
$TEXT['ANCHOR'] = 'Kotwica';
$TEXT['ANONYMOUS'] = 'Anonimowy';
$TEXT['ANY_WORDS'] = 'Dowolne ze slÃÂ³w';
...
$TEXT['BACKUP_MEDIA'] = 'Kopia zapasowa mediÃÂ³w';
...
$TEXT['CHARSET'] = 'Kodowanie znakÃÂ³w';
$TEXT['CHECKBOX_GROUP'] = 'Grupa pÃÂ³l zaznaczanych';
$TEXT['CLOSE'] = 'Zamknij';
$TEXT['CODE'] = 'Kod';
...
$TEXT['CREATE_FOLDER'] = 'UtwÃÂ³rz folder';
...
$TEXT['DEFAULT_CHARSET'] = 'Domyslne kodowanie znakÃÂ³w';
...
$TEXT['FILE'] = 'plik';
$TEXT['FILES'] = 'pliki';
$TEXT['FILESYSTEM_PERMISSIONS'] = 'Uprawnienia systemu plikÃÂ³w';
...
$TEXT['FORGOT_DETAILS'] = 'Zapomniales(-as) szczegÃÂ³lÃÂ³w?';
$TEXT['FROM'] = 'Od';
$TEXT['FRONTEND'] = 'Panel przedni';
$TEXT['FULL_NAME'] = 'Imie i nazwisko';
$TEXT['FUNCTION'] = 'Funkcja';
$TEXT['GROUP'] = 'Grupa';
$TEXT['HEADER'] = 'NaglÃÂ³wek';
$TEXT['HEADING'] = 'NaglÃÂ³wek';
...
$TEXT['INVALID_SIGNS'] = 'musi zaczynac sie od litery badz niedozwolonych znakÃÂ³w';
...
$TEXT['MEDIA_DIRECTORY'] = 'Katalog mediÃÂ³w';
$TEXT['MENU'] = 'Menu';
...
$TEXT['MODULE_PERMISSIONS'] = 'Uprawnienia do modulÃÂ³w';
$TEXT['MORE'] = 'Wiecej';
$TEXT['MOVE_DOWN'] = 'W dÃÂ³l';
$TEXT['MOVE_UP'] = 'Do gÃÂ³ry';
$TEXT['MULTILINGUAL'] = 'MULTILINGUAL';
$TEXT['MULTIPLE_MENUS'] = 'Wielokrotne menu';
$TEXT['MULTISELECT'] = 'WybÃÂ³r wielokrotny';
$TEXT['NAME'] = 'Nazwa';
...
$TEXT['NO_RESULTS'] = 'Brak wynikÃÂ³w';
...
$TEXT['PAGE_LEVEL_LIMIT'] = 'Limit poziomÃÂ³w stron';
...
$TEXT['PASSWORD'] = 'Haslo';
$TEXT['PATH'] = 'Sciezka';
$TEXT['PHP_ERROR_LEVEL'] = 'Poziom raportowania bledÃÂ³w PHP';
...
$TEXT['POST_HEADER'] = 'NaglÃÂ³wek wiadomosci';
...
$TEXT['RADIO_BUTTON_GROUP'] = 'Grupa pÃÂ³l przelaczanych';
$TEXT['READ'] = 'Odczytaj';
...
$TEXT['RESIZE_IMAGE_TO'] = 'Zmien rozmiar obrazkÃÂ³w na';
$TEXT['RESTORE'] = 'PrzywrÃÂ³c';
$TEXT['RESTORE_DATABASE'] = 'PrzywrÃÂ³c baze danych';
$TEXT['RESTORE_MEDIA'] = 'PrzywrÃÂ³c media';
$TEXT['RESULTS'] = 'Wyniki';
$TEXT['RESULTS_FOOTER'] = 'Stopka wynikÃÂ³w';
$TEXT['RESULTS_FOR'] = 'Wyniki dla';
$TEXT['RESULTS_HEADER'] = 'NaglÃÂ³wek wynikÃÂ³w';
$TEXT['RESULTS_LOOP'] = 'Petla wynikÃÂ³w';
$TEXT['RETYPE_NEW_PASSWORD'] = 'PowtÃÂ³rz nowe haslo';
$TEXT['RETYPE_PASSWORD'] = 'PowtÃÂ³rz haslo';
...
$TEXT['SEND_DETAILS'] = 'Wyslij szczegÃÂ³ly';
...
$TEXT['SHORT'] = 'KrÃÂ³tki';
$TEXT['SHORT_TEXT'] = 'KrÃÂ³tki tekst';
$TEXT['SHOW'] = 'Wyswietl';
...
$TEXT['TEMPLATE_PERMISSIONS'] = 'Uprawnienia szablonÃÂ³w';
$TEXT['TEXT'] = 'Tekst';
...
$TEXT['TITLE'] = 'Tytul';
$TEXT['TO'] = 'Do';
$TEXT['TOP_FRAME'] = 'GlÃÂ³wna ramka';
$TEXT['TRASH_EMPTIED'] = 'Smietnik oprÃÂ³niony';
...
$TEXT['USERS_FLAGS'] = 'Flagi uzytkownikÃÂ³w';
...
$TEXT['VIEW_DETAILS'] = 'Pokaz szczegÃÂ³ly';
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Okresl domyslny adres odbiorcy "FROM" i nadawcy "SENDER". Zaleca sie stosowanie ODBIORCY tak jak na przykladzie: <strong>admin@yourdomain.com</strong>. NiektÃÂ³rzy dostawcy maili (np. <em>mail.com</em>) moga odrzucic maile od ODBIORCY adresu takiego jak np <em>name@mail.com</em> ze wzgledu na potraktowanie tego jako spam.<br /><br /> Wartosci domyslne sa uzywane tylko wtedy inne wartosci sa okreslone przez WebsiteBakera. Jesli twÃÂ³j serwer obsluguje <acronym title="Prosty protokÃÂ³l przesylania poczty">SMTP</acronym>, mozesz skorzystac z tej funkcji.';
...
$TEXT['WEBSITE_HEADER'] = 'NaglÃÂ³wek witryny';
...
$TEXT['WINDOW'] = 'Okno';
$TEXT['WINDOWS'] = 'Okna';
$TEXT['WORLD_WRITEABLE_FILE_PERMISSIONS'] = 'Uprawnienia zapisywania plikÃÂ³w przez wszystkich';
$TEXT['WRITE'] = 'Zapisz';
...
$HEADING['ADD_HEADING'] = 'Dodaj naglÃÂ³wek';
...
$HEADING['CREATE_FOLDER'] = 'UtwÃÂ³rz folder';
$HEADING['DEFAULT_SETTINGS'] = 'Ustawienia domyslne';
$HEADING['DELETED_PAGES'] = 'Usuniete strony';
$HEADING['FILESYSTEM_SETTINGS'] = 'Ustawienia systemu plikÃÂ³w';
$HEADING['GENERAL_SETTINGS'] = 'Ustawienia ogÃÂ³lne';
$HEADING['INSTALL_LANGUAGE'] = 'Zainstaluj jezyk';
$HEADING['INSTALL_MODULE'] = 'Zainstaluj moduÃÂ³l';
$HEADING['INSTALL_TEMPLATE'] = 'Zainstaluj szablon';
$HEADING['INVOKE_LANGUAGE_FILES'] = 'Uaktywnij pliki jezykowe recznie';
$HEADING['INVOKE_MODULE_FILES'] = 'Uaktywnij pliki modulÃÂ³w recznie';
$HEADING['INVOKE_TEMPLATE_FILES'] = 'Uaktywnij pliki szablonÃÂ³w recznie';
$HEADING['LANGUAGE_DETAILS'] = 'SzczegÃÂ³ly jezyka';
...
$HEADING['MODULE_DETAILS'] = 'SzczegÃÂ³ly modulu';
$HEADING['MY_EMAIL'] = 'MÃÂ³j e-mail';
...
$HEADING['TEMPLATE_DETAILS'] = 'SzczegÃÂ³ly szablonu';
...
$MESSAGE['ADDON_PRECHECK_FAILED'] = 'Instalacja dodatku. TwÃÂ³j system nie spelnia wymogÃÂ³w niniejszego dodatku. Aby system pracowal z tym dodatkiem nalezy rozwiazac kwestie przedstawione ponizej.';
$MESSAGE['ADDON_RELOAD'] = 'Aktualizacja bazy danych z informacjami dodatkÃÂ³w (np. po FTP).';
...
$MESSAGE['FORGOT_PASS_NO_DATA'] = 'Prosze wprowadzic ponizej swÃÂ³j adres e-mail';
...
$MESSAGE['GENERIC_FILE_TYPE'] = 'Prosze zwrÃÂ³cic uwage, ze ladowany plik musi byc w formacie:';
$MESSAGE['GENERIC_FILE_TYPES'] = 'Prosze zwrÃÂ³cic uwage, ze ladowany plik musi byc w jednym z formatÃÂ³w:';
...
$MESSAGE['GENERIC_PLEASE_CHECK_BACK_SOON'] = 'Zapraszamy wkrÃÂ³tce...';
...
$MESSAGE['GENERIC_VERSION_COMPARE'] = 'PorÃÂ³wnyanie wersji';
...
$MESSAGE['GROUPS_CONFIRM_DELETE'] = 'Czy aby na pewno usunac wybrana grupe (i wszystkich uzytkownikÃÂ³w, ktÃÂ³rzy do niej naleza)?';
...
$MESSAGE['LOGIN_PASSWORD_TOO_LONG'] = 'Wprowadzone haslo jest zbyt krÃÂ³tkie';
$MESSAGE['LOGIN_PASSWORD_TOO_SHORT'] = 'Wprowadzone haslo jest zbyt krÃÂ³tkie';
...
$MESSAGE['MEDIA_NONE_FOUND'] = 'Nie odnaleziono zadnych mediÃÂ³w w biezacym folderze';
...
$MESSAGE['MOD_FORM_REQUIRED_FIELDS'] = 'Nalezy wprowadzic szczegÃÂ³ly dla nastepujacych pÃÂ³l';
$MESSAGE['PAGES_ADDED'] = 'Strona zostala dodana';
$MESSAGE['PAGES_ADDED_HEADING'] = 'NaglÃÂ³wek strony zostal dodany';
...
$MESSAGE['PAGES_RESTORED'] = 'Strona zostala przywrÃÂ³cona';
$MESSAGE['PAGES_RETURN_TO_PAGES'] = 'PowrÃÂ³t do stron';
...
$MESSAGE['PREFERENCES_DETAILS_SAVED'] = 'SzczegÃÂ³ly zostaly zapisane';
...
SzczegÃÂ³ly twojego nowego konta \'{LOGIN_WEBSITE_TITLE}\' ponizej:
...
SzczegÃÂ³ly konta \'{LOGIN_WEBSITE_TITLE}\' ponizej:
Loginname: {LOGIN_NAME}
Haslo: {LOGIN_PASSWORD}
...
$MESSAGE['USERS_PASSWORD_TOO_SHORT'] = 'Wprowadzone haslo bylo za krÃÂ³tkie';
...
$OVERVIEW['MEDIA'] = 'Zarzadzaj plikami przechowywanymi w folderze mediÃÂ³w...';
