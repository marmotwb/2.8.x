...
$MENU['ADDON'] = 'Add-on';
$MENU['ADDONS'] = 'Kieg&eacute;sz&iacute;tâ•¨Ð¤â”¬Ð»';
...
$TEXT['ADVANCED'] = 'Bâ•¨Ð¤â”¬â•¢&iacute;tett';
...
$TEXT['EXPAND'] = 'Kibont';
$TEXT['EXTENSION'] = 'Bâ•¨Ð¤â”¬â•¢&iacute;tm&eacute;ny';
...
$TEXT['LONG'] = 'Hosszâ•¨Ð¥â”¬â–’';
$TEXT['LONG_TEXT'] = 'Hossz&uacute; sz&ouml;veg';
$TEXT['LOOP'] = 'ism&eacute;tlâ•¨Ð¤â”¬Ð´&uuml;/br&gt; t&ouml;rzs szakasz';
$TEXT['MAIN'] = 'F&ccedil;';
...
$TEXT['MORE'] = 'Bâ•¨Ð¤â”¬â•¢ebben';
$TEXT['MOVE_DOWN'] = 'Mozgat Le';
$TEXT['MOVE_UP'] = 'Mozgat Fel';
$TEXT['MULTIPLE_MENUS'] = 'T&ouml;bbszintâ•¨Ð¥â”¬â–’ men&uuml;';
...
$TEXT['PREVIOUS'] = 'Elâ•¨Ð¤â•¤Ð¤&ccedil;';
$TEXT['PREVIOUS_PAGE'] = 'Elâ•¨Ð¤â•¤Ð¤&agrave;oldal';
...
$TEXT['TABLE_PREFIX'] = 'T&aacute;bla elâ•¨Ð¤â•¥Ð¡ag';
...
$TEXT['TIME'] = 'Id&ccedil;';
$TEXT['TIMEZONE'] = 'Idâ•¨Ð¤â•¤Ð¤&oacute;na';
...
/* HEADING */
$HEADING['ADDON_PRECHECK_FAILED'] = 'Kieg&eacute;sz&iacute;t&agrave;k&ouml;vetelm&eacute;nyek nem megfelelâ•¨Ð¤â•¥Ð k';
...
$MESSAGE['GENERIC_FILL_IN_ALL'] = 'K&eacute;rem t&eacute;rjen vissza &eacute;s t&ouml;lts&ouml;n ki minden mezâ•¨Ð¤â•¥Ð¡';
...
$MESSAGE['GENERIC_INVALID_ADDON_FILE'] = '&sup2;v&eacute;nytelen WebsiteBaker telep&iacute;t&agrave;f&aacute;jl. K&eacute;rlek ellenâ•¨Ð¤â•¨Ð–izd a *.zip form&aacute;tumot.';
$MESSAGE['GENERIC_INVALID_LANGUAGE_FILE'] = '&sup2;v&eacute;nytelen WebsiteBaker nyelvi f&aacute;jl. K&eacute;rlek ellenâ•¨Ð¤â•¨Ð–izd a sz&ouml;veges f&aacute;jlt.';
...
$MESSAGE['GENERIC_PLEASE_CHECK_BACK_SOON'] = 'K&eacute;rem t&eacute;rjen vissza k&eacute;sâ•¨Ð¤â•¤Ð®b!';
...
$MESSAGE['GROUPS_CONFIRM_DELETE'] = 'Biztos, hogy t&ouml;r&ouml;lni akarja a kijel&ouml;lt csoportot? (Minden felhaszn&aacute;l&oacute;ja t&ouml;rlâ•¨Ð¤â”¬Ð´ik)';
...
$MESSAGE['MEDIA_DIR_DOES_NOT_EXIST'] = 'Nem lehet ../ a c&eacute;l mezâ•¨Ð¤â•¤Ð®en';
$MESSAGE['MEDIA_DIR_DOT_DOT_SLASH'] = 'Nem tartalmazhat ../ -t a k&ouml;nyvt&aacute;r n&eacute;v';
$MESSAGE['MEDIA_DIR_EXISTS'] = 'Ilyen nevâ•¨Ð¥â”¬â–’ k&ouml;nyvt&aacute;r m&aacute;r l&eacute;tezik';
...
$MESSAGE['MEDIA_FILE_EXISTS'] = 'Ilyen nevâ•¨Ð¥â”¬â–’ file m&aacute;r l&eacute;tezik';
...
$MESSAGE['MOD_FORM_EXCESS_SUBMISSIONS'] = 'Sajn&aacute;ljuk, de ez az â•¨Ð¥â”¬â–’rlap t&uacute;l sokszor lett kit&ouml;ltve egy &oacute;ran bel&uuml;l! K&eacute;rem pr&oacute;b&aacute;lja meg egy &oacute;ra m&uacute;lva';
...
$MESSAGE['MOD_FORM_REQUIRED_FIELDS'] = 'A k&ouml;vetkez&agrave;mezâ•¨Ð¤â”¬Ð»et k&ouml;telez&agrave;kit&ouml;ltenie';
