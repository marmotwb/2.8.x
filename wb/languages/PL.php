...
$TEXT['ANY_WORDS'] = 'Dowolne ze slÃ³w';
...
$TEXT['DEFAULT_CHARSET'] = 'Domyslne kodowanie znakÃ³w';
...
$TEXT['EMPTY_TRASH'] = 'OprÃ³znij smietnik';
...
$TEXT['FORGOT_DETAILS'] = 'Zapomniales(-as) szczegÃ³lÃ³w?';
$TEXT['FROM'] = 'Od';
$TEXT['FRONTEND'] = 'Panel przedni';
$TEXT['FULL_NAME'] = 'Imie i nazwisko';
$TEXT['FUNCTION'] = 'Funkcja';
$TEXT['GROUP'] = 'Grupa';
$TEXT['HEADER'] = 'NaglÃ³wek';
$TEXT['HEADING'] = 'NaglÃ³wek';
...
$TEXT['INVALID_SIGNS'] = 'musi zaczynac sie od litery badz niedozwolonych znakÃ³w';
...
$TEXT['MODULE_PERMISSIONS'] = 'Uprawnienia do modulÃ³w';
$TEXT['MORE'] = 'Wiecej';
$TEXT['MOVE_DOWN'] = 'W dÃ³l';
...
$TEXT['PASSWORD'] = 'Haslo';
$TEXT['PATH'] = 'Sciezka';
$TEXT['PHP_ERROR_LEVEL'] = 'Poziom raportowania bledÃ³w PHP';
...
$TEXT['POST_HEADER'] = 'NaglÃ³wek wiadomosci';
...
$TEXT['RADIO_BUTTON_GROUP'] = 'Grupa pÃ³l przelaczanych';
$TEXT['READ'] = 'Odczytaj';
...
$TEXT['RESIZE_IMAGE_TO'] = 'Zmien rozmiar obrazkÃ³w na';
$TEXT['RESTORE'] = 'PrzywrÃ³c';
$TEXT['RESTORE_DATABASE'] = 'PrzywrÃ³c baze danych';
$TEXT['RESTORE_MEDIA'] = 'PrzywrÃ³c media';
$TEXT['RESULTS'] = 'Wyniki';
$TEXT['RESULTS_FOOTER'] = 'Stopka wynikÃ³w';
$TEXT['RESULTS_FOR'] = 'Wyniki dla';
$TEXT['RESULTS_HEADER'] = 'NaglÃ³wek wynikÃ³w';
$TEXT['RESULTS_LOOP'] = 'Petla wynikÃ³w';
$TEXT['RETYPE_NEW_PASSWORD'] = 'PowtÃ³rz nowe haslo';
$TEXT['RETYPE_PASSWORD'] = 'PowtÃ³rz haslo';
...
$TEXT['SEND_DETAILS'] = 'Wyslij szczegÃ³ly';
...
$TEXT['TITLE'] = 'Tytul';
$TEXT['TO'] = 'Do';
$TEXT['TOP_FRAME'] = 'GlÃ³wna ramka';
$TEXT['TRASH_EMPTIED'] = 'Smietnik oprÃ³niony';
...
$TEXT['USERS_FLAGS'] = 'Flagi uzytkownikÃ³w';
...
$TEXT['VIEW_DETAILS'] = 'Pokaz szczegÃ³ly';
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Okresl domyslny adres odbiorcy "FROM" i nadawcy "SENDER". Zaleca sie stosowanie ODBIORCY tak jak na przykladzie: <strong>admin@yourdomain.com</strong>. NiektÃ³rzy dostawcy maili (np. <em>mail.com</em>) moga odrzucic maile od ODBIORCY adresu takiego jak np <em>name@mail.com</em> ze wzgledu na potraktowanie tego jako spam.<br /><br /> Wartosci domyslne sa uzywane tylko wtedy inne wartosci sa okreslone przez WebsiteBakera. Jesli twÃ³j serwer obsluguje <acronym title="Prosty protokÃ³l przesylania poczty">SMTP</acronym>, mozesz skorzystac z tej funkcji.';
...
$TEXT['WEBSITE_HEADER'] = 'NaglÃ³wek witryny';
...
$HEADING['ADD_HEADING'] = 'Dodaj naglÃ³wek';
...
$HEADING['INSTALL_MODULE'] = 'Zainstaluj moduÃ³l';
$HEADING['INSTALL_TEMPLATE'] = 'Zainstaluj szablon';
$HEADING['INVOKE_LANGUAGE_FILES'] = 'Uaktywnij pliki jezykowe recznie';
$HEADING['INVOKE_MODULE_FILES'] = 'Uaktywnij pliki modulÃ³w recznie';
$HEADING['INVOKE_TEMPLATE_FILES'] = 'Uaktywnij pliki szablonÃ³w recznie';
$HEADING['LANGUAGE_DETAILS'] = 'SzczegÃ³ly jezyka';
...
$HEADING['MODULE_DETAILS'] = 'SzczegÃ³ly modulu';
...
$HEADING['TEMPLATE_DETAILS'] = 'SzczegÃ³ly szablonu';
...
$MESSAGE['ADDON_MANUAL_FTP_LANGUAGE'] = '<strong>UWAGA!</strong> Ze wzgledÃ³w bezpieczenstwa przeslanie plikÃ³w jezykowych do folderu /languages/ powinno odbyc sie tylko przez FTP.';
...
$MESSAGE['ADDON_PRECHECK_FAILED'] = 'Instalacja dodatku. TwÃ³j system nie spelnia wymogÃ³w niniejszego dodatku. Aby system pracowal z tym dodatkiem nalezy rozwiazac kwestie przedstawione ponizej.';
...
$MESSAGE['FORGOT_PASS_NO_DATA'] = 'Prosze wprowadzic ponizej swÃ³j adres e-mail';
...
$MESSAGE['GENERIC_FILE_TYPE'] = 'Prosze zwrÃ³cic uwage, ze ladowany plik musi byc w formacie:';
$MESSAGE['GENERIC_FILE_TYPES'] = 'Prosze zwrÃ³cic uwage, ze ladowany plik musi byc w jednym z formatÃ³w:';
...
$MESSAGE['GROUPS_CONFIRM_DELETE'] = 'Czy aby na pewno usunac wybrana grupe (i wszystkich uzytkownikÃ³w, ktÃ³rzy do niej naleza)?';
...
$MESSAGE['LOGIN_PASSWORD_TOO_LONG'] = 'Wprowadzone haslo jest zbyt krÃ³tkie';
$MESSAGE['LOGIN_PASSWORD_TOO_SHORT'] = 'Wprowadzone haslo jest zbyt krÃ³tkie';
...
$MESSAGE['MEDIA_NONE_FOUND'] = 'Nie odnaleziono zadnych mediÃ³w w biezacym folderze';
...
$MESSAGE['MOD_FORM_EXCESS_SUBMISSIONS'] = 'Niestety, ten formularz zostal wyslany zbyt wiele razy w ciagu tej godziny. Prosimy sprÃ³bowac ponownie za godzine.';
...
$MESSAGE['MOD_FORM_REQUIRED_FIELDS'] = 'Nalezy wprowadzic szczegÃ³ly dla nastepujacych pÃ³l';
$MESSAGE['PAGES_ADDED'] = 'Strona zostala dodana';
$MESSAGE['PAGES_ADDED_HEADING'] = 'NaglÃ³wek strony zostal dodany';
...
$MESSAGE['PAGES_RESTORED'] = 'Strona zostala przywrÃ³cona';
...
$MESSAGE['PREFERENCES_DETAILS_SAVED'] = 'SzczegÃ³ly zostaly zapisane';
...
SzczegÃ³ly twojego nowego konta \'{LOGIN_WEBSITE_TITLE}\' ponizej:
...
SzczegÃ³ly konta \'{LOGIN_WEBSITE_TITLE}\' ponizej:
Loginname: {LOGIN_NAME}
Haslo: {LOGIN_PASSWORD}
...
$MESSAGE['USERS_PASSWORD_TOO_SHORT'] = 'Wprowadzone haslo bylo za krÃ³tkie';
...
$OVERVIEW['GROUPS'] = 'Zarzadzaj grupami uzytkownikÃ³w i ich uprawnieniami systemowymi...';
$OVERVIEW['HELP'] = 'Masz pytania? Znajdz odpowiedzi...';
$OVERVIEW['LANGUAGES'] = 'Zarzadzaj jezykami WebsiteBakera...';
$OVERVIEW['MEDIA'] = 'Zarzadzaj plikami przechowywanymi w folderze mediÃ³w...';
...
$OVERVIEW['TEMPLATES'] = 'Zmien wyglad swojej strony za pomoca szablonÃ³w...';
